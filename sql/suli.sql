...
/*!40000 ALTER TABLE `diak`
    DISABLE KEYS */;
INSERT INTO `diak` (`id`, `nev`, `szuldatum`, `naplo_id`)
VALUES (1, 'Szabó Tünde', '2010-02-10', 1),
...
/*!40000 ALTER TABLE `jegy`
    DISABLE KEYS */;
INSERT INTO `jegy` (`id`, `ertek`, `leiras`, `datum`, `diak_id`, `tantargy`)
VALUES (1, 5, 'jeles', '2022-01-03', 1, 'magyar'),
...
/*!40000 ALTER TABLE `naplo`
    DISABLE KEYS */;
INSERT INTO `naplo` (`id`, `leiras`)
VALUES (1, '6B'),
       (2, '6C');
/*!40000 ALTER TABLE `naplo`
    ENABLE KEYS */;
