...
class ActivityDaoTest {
    ...
    void someTrackPoints() {
        ...
        var actual = activityDao.someTrackPoints(1);

        assertEquals(12, actual.get(0).getLat(), 0.4);
        assertEquals(14, actual.get(1).getLat(), 0.4);
        assertEquals(18, actual.get(2).getLat(), 0.4);
